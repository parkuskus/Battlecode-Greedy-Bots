...
/**
 * Navigation with anti-oscillation.
 * Tracks last 6 positions in a ring buffer.
 * Movement penalizes recently-visited tiles to prevent back-and-forth.
 */
public class Nav {

    /* ---- position history ring buffer (anti-oscillation) ---- */
    ...
    /* ---- BugNav (wall-following with anti-oscillation) ---- */
    ...
    static int tileScore(MapLocation loc) throws GameActionException {
        ...
        // Spec: each adjacent ally robot costs 1 paint/round (2 on enemy territory)
        // Penalize crowded tiles to spread paint coverage
