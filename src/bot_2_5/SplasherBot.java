...
/**
 * Greedy Splasher — focused on maximum paint coverage.
 * Same as bot_2_4 with package fix.
 */
public class SplasherBot {
    ...
    private static MapLocation bestSplashTarget(RobotController rc,
        ...
        for (MapLocation loc : locs) {
            ...
            int value = 0;
            // Inner ring (dist² ≤ 2): can overwrite enemy paint per spec
            ...
            // Outer ring (dist² = 4): can paint empty but NOT overwrite enemy
