...
public class SoldierBot {
    ...
    // algoritma greedy priority
    // kode dieksekusi berdasarkan prioritas pada if statement tanpa melihat kondisi sekitar soldier saat round berlangsung
    ...
    // REFILL STATE
    // greedy ke tower yang memiliki jarak paling pendek lewat findVisiblePaintTower()
    private static void refillState(RobotController rc, MapLocation me,
        ...
        if (visibleTower != null) {
            ...
            // cari informasi jika tower terdekat tidak ketemu
    ...
    // COMBAT STATE
    // greedy langsung mencari tower musuh terdekat 
    ...
    // greedy saat ketemu tower langsung bangun
    ...
    // BUILDING SRP STATE
    // greedy dengan langsung bergerak ke lokasi bestSRP tanpa memedulikan ada apa di rute perjalanannya
    ...
    // greedy painting - jika ketemu pertama kali tile musuh langsung warnai
    ...
    // mencari ruins terbaik yang dapat diselesaikan menggunakan metode scoring
    private static MapLocation findBestRuin(RobotController rc, MapLocation me,
        ...
        for (MapLocation ruin : ruins) {
            ...
            if (rc.senseRobotAtLocation(ruin) != null) continue; // sudah dibangun tower
